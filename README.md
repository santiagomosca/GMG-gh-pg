# Sitio Web del Grupo de Materiales Granulares
Requisitos para usar este repositorio:

Tener versión 0.78 o más de Hugo. Es necesario descargar el binario de la versión ['extended'](https://github.com/gohugoio/hugo/releases).

Instalar las dependencias de Go. Es recomendable descargar el binario para utilizar la mínima versión requerida ([15.5](https://golang.org/dl/)).
